...
class ArffFormatProviderTest {
  ...
  void testOptionDescriptions() {
    ...
    assertTrue(Matrix.listReadOptions('arff').contains('instanceWeightColumn'))
    assertTrue(Matrix.listReadOptions('arff').contains('failOnUndeclaredNominalValue'))
    assertTrue(Matrix.listReadOptions('arff').contains('dateMode'))
    assertTrue(Matrix.listWriteOptions('arff').contains('dateMode'))
