...
1.1 [x] Add reader overloads for `Reader`, `String` content, `readFile(String)`, and `readUrl(String)`
...
5.1 [x] Add tests for new input overloads (Reader, String content, readFile, readUrl)
