...
class GeomBoxplot extends Geom {
  ...
  GeomBoxplot() {
    ...
    defaultAes = [fill: 'white', color: 'black', alpha: 1.0]
  }
  ...
  GeomBoxplot(Map params) {
    this()
    if (params.fill) {
      this.fill = params.fill as String
    }
    if (params.color) {
    ...
    if (params.varwidth != null) {
      this.varwidth = params.varwidth as Boolean
    }
    if (params.var_width != null) {
      this.varwidth = params.var_width as Boolean
    }
    if (params.outliers != null) {
      this.outliers = params.outliers as boolean
    }
    if (params.outlierSize != null) {
      this.outlierSize = params.outlierSize as Number
    }
    if (params.outlier_size != null) {
      this.outlierSize = params.outlier_size as Number
    }
    if (params.outlierShape) {
      this.outlierShape = params.outlierShape as String
    }
    if (params.outlier_shape) {
      this.outlierShape = params.outlier_shape as String
    }
    if (params.outlierColor) {
      this.outlierColor = params.outlierColor as String
    }
    if (params.outlier_color) {
      this.outlierColor = params.outlier_color as String
    }
    if (params.stapleWidth != null) {
      this.stapleWidth = params.stapleWidth as Number
    }
    if (params.staple_width != null) {
      this.stapleWidth = params.staple_width as Number
    }
