...
- Fix directory-target writes to normalize Matrix names to a single Windows-safe `.parquet` filename and confine it to the supplied existing directory. Explicit file targets remain unchanged.
