...
**Issue:** Two test methods are empty placeholders with TODO comments.

**Empty Tests:**
1. `testDesityHistogram()` - Line ~72
2. `testFrequencyHistogramCustom()` - Line ~76

**Tasks:**
- 2.1 [ ] Implement testDesityHistogram() to test density histogram functionality
- 2.2 [ ] Implement testFrequencyHistogramCustom() to test custom frequency histogram
- 2.3 [ ] Run tests: `./gradlew :matrix-xchart:test --tests "HistogramChartTest"`
...
**Tasks:**
- 3.1 [ ] Add class-level GroovyDoc to MatrixXChart interface
- 3.2 [ ] Add method-level GroovyDoc to all MatrixXChart interface methods
- 3.3 [ ] Add class-level GroovyDoc to AbstractChart
- 3.4 [ ] Add method-level GroovyDoc to all public AbstractChart methods (exportPng, exportSvg, etc.)
- 3.5 [ ] Add class-level GroovyDoc to AbstractXYChart
- 3.6 [ ] Add class-level GroovyDoc to AbstractCategoryChart
- 3.7 [ ] Generate GroovyDoc to verify: `./gradlew :matrix-xchart:groovydoc`
...
**Tasks:**
- 4.1 [ ] Update README line 13 to version 0.2.3
- 4.2 [ ] Verify other version references are correct (matrix-core:3.3.0, groovy:5.0.4)
...
**Tasks:**
- 5.1 [ ] Add complete StickChart description to README.md line 79
- 5.2 [ ] Review other chart descriptions for completeness
...
**Tasks:**
- 6.1 [ ] Replace Math.ceil() with NumberExtension.ceil() in AbstractChart.groovy:90
- 6.2 [ ] Replace Math.sqrt() with ** 0.5 or .sqrt() in HeatmapChart.groovy:59
- 6.3 [ ] Run tests: `./gradlew :matrix-xchart:test`
