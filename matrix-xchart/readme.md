[![Maven Central](https://maven-badges.sml.io/maven-central/se.alipsa.matrix/matrix-xchart/badge.svg)](https://maven-badges.sml.io/maven-central/se.alipsa.matrix/matrix-xchart)
