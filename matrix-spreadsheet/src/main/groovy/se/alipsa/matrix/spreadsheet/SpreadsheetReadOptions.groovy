...
class SpreadsheetReadOptions {
  ...
  static List<OptionDescriptor> descriptors() {
    [
        ...
        new OptionDescriptor(OPT_END_COLUMN, Object, DEFAULT_AUTO, 'Column to stop at, as a name like D or a 1-based column number (auto-detect scans the first 10 rows)'),
