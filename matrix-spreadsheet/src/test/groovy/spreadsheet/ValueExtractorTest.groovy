...
class ValueExtractorTest {
  ...
  void testGetInt() {
    ...
    assertEquals(42, ValueExtractor.getInt(42.00G))
    assertEquals(43, ValueExtractor.getInt(42.60G))
    assertThrows(ArithmeticException, () -> ValueExtractor.getInt(3000000000L))
    assertEquals(42, ValueExtractor.getInt('42'))
  ...
  void testGetLong() {
    ...
    assertEquals(42L, extractor.getLong(42.00G))
    assertEquals(43L, extractor.getLong(42.60G))
    assertEquals(9007199254740993L, extractor.getLong(9007199254740993G))
    assertEquals(42L, extractor.getLong('42'))
