...
- 3.1.2 [x] `geom_hex()` - Hexagonal binning
- 3.1.3 [x] `geom_dotplot()` - Dot plots
- 3.1.4 [x] `geom_curve()` - Curved line segments
- 3.1.5 [x] `geom_spoke()` - Radial line segments from point
- 3.1.6 [x] `geom_density_2d()` - 2D density contour lines
- 3.1.7 [x] `geom_density_2d_filled()` - Filled 2D density contours
...
- 3.4.1 [x] `theme_void()` - Completely blank canvas
- 3.4.2 [x] `theme_light()` - Light background theme
- 3.4.3 [x] `theme_dark()` - Dark background theme
- 3.4.4 [x] `theme_linedraw()` - Black lines, no grey
