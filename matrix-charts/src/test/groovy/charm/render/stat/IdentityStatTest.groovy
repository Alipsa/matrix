...
import se.alipsa.matrix.charm.render.stat.IdentityStat

import static org.junit.jupiter.api.Assertions.*

class IdentityStatTest {
  ...
  void testPassThrough() {
    ...
    List<LayerData> result = IdentityStat.compute(layer, data)
  ...
  void testPreservesAllFields() {
    ...
    List<LayerData> result = IdentityStat.compute(layer, [datum])
