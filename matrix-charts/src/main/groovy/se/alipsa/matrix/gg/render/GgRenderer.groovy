...
class GgRenderer {
  ...
  private Map<String, List> collectAestheticData(GgChart chart, Coord coord) {
    ...
    chart.layers.each { layer ->
      ...
      // Process layer if: - It has aesthetics and data, or - it can generate data from null
  ...
  /**
   * Resolve the guide type for an aesthetic from guides or scale.
   */
  ...
  /**
   * Estimate the width needed for the legend based on label lengths.
   */
