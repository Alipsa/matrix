...
# TODO
Move gg functionality from matrix-charts into its own subproject called matrix-ggcharts. 
Charm and Charts in matrix-charts should be unaffected by the move from a functionality standpoint 
(though some things might need to be made accessible from the new ggcharts project). 
matrix-ggcharts should depend on matrix-charts and the gg (ggplot2 like api) should use the 
charm implementation for the actual implementation functionality just like today. 
Include moving documentation in the plan.
