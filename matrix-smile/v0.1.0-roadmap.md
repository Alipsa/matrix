...
**Tasks:**
- 2.1 [ ] Update README line 8 to specify "Groovy 5.0+" instead of "Groovy 4.x"
- 2.2 [ ] Verify the change matches actual Groovy version in dependencies.gradle (currently 5.0.4)
- 2.3 [ ] Consider adding a note that arrow-style switch expressions require Groovy 5.0+
...
**Tasks:**
- 3.1 [ ] Update documentation example at line 305 to remove println suggestion
- 3.2 [ ] Review other doc examples in Gsmile.groovy for println usage
- 3.3 [ ] Generate groovydoc to verify example appears correctly: `./gradlew :matrix-smile:groovydoc`
...
**Tasks:**
- 4.1 [ ] Update moduleVersion to 0.1.0 in ExtensionModule file
- 4.2 [ ] Rebuild and verify extension loads: `./gradlew :matrix-smile:build`
- 4.3 [ ] Run extension tests: `./gradlew :matrix-smile:test --tests "GsmileTest"`
