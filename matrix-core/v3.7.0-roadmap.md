...
#### 1.12.1 [ ] Create helper package and extract static helpers
...
#### 1.12.2 [ ] Audit missing Matrix unit tests
...
#### 1.12.3 [ ] Move RowExtension/ColumnExtension into core ext package
