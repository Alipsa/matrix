...
**Files:**
- `matrix-bigquery/src/main/groovy/se/alipsa/matrix/bigquery/Bq.groovy`
- `matrix-charts/src/main/groovy/se/alipsa/matrix/chart/png/PngConverter.groovy`
- `matrix-core/src/main/groovy/se/alipsa/matrix/core/ListConverter.groovy`
- `matrix-sql/src/main/groovy/se/alipsa/matrix/sql/config/JaasConfigLoader.groovy`
- `matrix-sql/src/main/groovy/se/alipsa/matrix/sql/MatrixSqlFactory.groovy`
- `matrix-gsheets/src/main/groovy/se/alipsa/matrix/gsheets/GsConverter.groovy`
- `matrix-gsheets/src/main/groovy/se/alipsa/matrix/gsheets/BqAuthenticator.groovy`
...
**Files:**
- `matrix-core/src/main/groovy/se/alipsa/matrix/core/MatrixBuilder.groovy`
- `matrix-core/src/main/groovy/se/alipsa/matrix/core/Matrix.groovy`
- `matrix-core/src/main/groovy/se/alipsa/matrix/core/ValueConverter.groovy`
- `matrix-core/src/main/groovy/se/alipsa/matrix/core/RowExtension.groovy`
- `matrix-core/src/main/groovy/se/alipsa/matrix/core/Stat.groovy`
- `matrix-core/src/main/groovy/se/alipsa/matrix/core/util/ClassUtils.groovy`
...
**File:** `matrix-core/src/main/groovy/se/alipsa/matrix/matrix/core/Row.groovy:81`
...
**File:** `matrix-core/src/main/groovy/se/alipsa/matrix/core/Joiner.groovy:14`
...
**File:** `matrix-core/src/main/groovy/se/alipsa/matrix/matrix/Matrix.groovy` (2,814 lines)
...
**Files:**
- `matrix-spreadsheet/src/main/groovy/se/alipsa/matrix/spreadsheet/ExcelImporter.groovy:128,166,207`
- `matrix-spreadsheet/src/main/groovy/se/alipsa/matrix/spreadsheet/FExcelImporter.groovy:264`
...
**File:** `matrix-spreadsheet/src/main/groovy/se/alipsa/matrix/spreadsheet/FOdsImporter.groovy:258`
...
**File:** `matrix-stats/src/main/groovy/se/alipsa/matrix/stats/cluster/KMeansPlusPlus.groovy:531`
...
**File:** `matrix-charts/src/main/groovy/se/alipsa/matrix/core/chart/DataType.groovy:12`

TODO comment: "maybe do something with dates" - Date type handling is incomplete.

### Clarify groupCol behavior in AreaChart
**File:** `matrix-charts/src/main/groovy/se/alipsa/matrix/core/hart/AreaChart.groovy:41`

TODO comment: "figure out how groupCol works" - Grouping behavior is unclear.

### Make tick label rotation a styling option
**File:** `matrix-charts/src/main/groovy/se/alipsa/matrix/core/chart/JfxBarChartConverter.groovy:17,26`
