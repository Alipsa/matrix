...
- Made trigonometric range reduction calculate π at a precision derived from the angle magnitude, reject requests above 2,048 digits, and cache eligible values for reuse.
